...
{ 
    ...
    cout << "Encrypt Finished! Press Any Key to continue!" << endl;
}
...
void deCryptS(string key, string eFile_name, string file_name)
{
    ...
    cout << "Decrypt Finished! Press Any Key to continue!" << endl;
}
...
int main()
{
    //enCryptS("FKey", "Text.txt", "eText.txt");   // code used for quick testing
